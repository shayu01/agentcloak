...
class TestProfileNameValidation:
    def test_valid_simple_name(self) -> None:
        from browserctl.cli.commands.profile import _validate_name
...
class TestDirSizeBytes:
    def test_empty_dir(self, tmp_path: Path) -> None:
        from browserctl.cli.commands.profile import _dir_size_bytes
...
class TestHumanSize:
    def test_bytes(self) -> None:
        from browserctl.cli.commands.profile import _human_size
