...
from browserctl.adapters.registry import adapter
from browserctl.adapters.types import Arg
...
@adapter(
    ...
    access="read",
    args=(Arg("user-agent", default="browserctl/0.1", help="Custom User-Agent"),),
    pipeline=[
        {
            "fetch": {
